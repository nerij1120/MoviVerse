...
import com.example.movieapp.viewmodel.discovery.MoviesViewModel
...
class MoviesFragment : BaseFragment<FragmentMoviesBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentMoviesBinding
        get() = {
            ...
            FragmentMoviesBinding.inflate(layoutInflater, viewGroup, b)
        }
    ...
    override fun setView() {
        ...
        adapter = MovieSearchAdapter(moviesList){ movie->
