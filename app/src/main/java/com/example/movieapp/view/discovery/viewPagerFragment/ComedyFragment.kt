...
import com.example.movieapp.databinding.FragmentComedyBinding
import com.example.movieapp.model.Movie
import com.example.movieapp.view.activity.DetailsActivity
import com.example.movieapp.view.activity.MainActivity
import com.example.movieapp.viewmodel.discovery.ComedyViewModel
...
class ComedyFragment : BaseFragment<FragmentComedyBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentComedyBinding
        get() = {
            layoutInflater, viewGroup, b ->
            FragmentComedyBinding.inflate(layoutInflater, viewGroup, b)
        }
