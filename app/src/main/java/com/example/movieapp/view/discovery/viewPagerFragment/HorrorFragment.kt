...
import com.example.movieapp.databinding.FragmentHorrorBinding
import com.example.movieapp.model.Movie
import com.example.movieapp.view.activity.DetailsActivity
import com.example.movieapp.view.activity.MainActivity
import com.example.movieapp.viewmodel.discovery.HorrorViewModel
...
class HorrorFragment : BaseFragment<FragmentHorrorBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentHorrorBinding
        get() = {
            layoutInflater, viewGroup, b ->
            FragmentHorrorBinding.inflate(layoutInflater, viewGroup, b)
        }
