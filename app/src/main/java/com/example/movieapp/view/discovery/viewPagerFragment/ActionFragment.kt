...
import com.example.movieapp.databinding.FragmentActionBinding
import com.example.movieapp.model.Movie
import com.example.movieapp.view.activity.DetailsActivity
import com.example.movieapp.view.activity.MainActivity
import com.example.movieapp.viewmodel.discovery.ActionViewModel
...
class ActionFragment : BaseFragment<FragmentActionBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentActionBinding
        get() = {
            layoutInflater, viewGroup, b ->
            FragmentActionBinding.inflate(layoutInflater, viewGroup, b)
        }
