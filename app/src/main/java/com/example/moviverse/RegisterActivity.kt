...
import com.example.moviverse.databinding.ActivityRegisterBinding
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    binding.progressBar.visibility = View.GONE
                    Snackbar.make(binding.registerBtn, "${task.exception?.message}", Snackbar.LENGTH_SHORT).show()
                }
            }
    }
