...
import com.example.moviverse.databinding.FragmentComedyBinding
import com.example.moviverse.viewmodel.DetailsViewModel
import com.example.moviverse.viewmodel.discovery.ComedyViewModel
import java.util.*
...
class ComedyFragment : Fragment() {
    private lateinit var viewModel: ComedyViewModel
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComedyBinding.inflate(inflater, container, false)

        viewModel = ViewModelProvider(this)[ComedyViewModel::class.java]
        ...
        adapter = MovieSearchAdapter(ArrayList(), onClick = {
            ...
            val extras = FragmentNavigatorExtras(
                poster to "movie_poster_${movie.id}_4",
                title to "movie_title_${movie.id}_4",
            )
            findNavController().navigate(
                BottomNavDirections.discoveryToDetails(4),
                extras
            )
        },4)
