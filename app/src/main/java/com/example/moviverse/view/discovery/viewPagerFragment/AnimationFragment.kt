...
import com.example.moviverse.databinding.FragmentAnimationBinding
import com.example.moviverse.viewmodel.DetailsViewModel
import com.example.moviverse.viewmodel.discovery.AnimationViewModel
import java.util.*
    ...
    override fun onCreateView(
        ...
        adapter = MovieSearchAdapter(ArrayList(), onClick = {
            ...
            val extras = FragmentNavigatorExtras(
                poster to "movie_poster_${movie.id}_7",
                title to "movie_title_${movie.id}_7",
            )
            findNavController().navigate(
                BottomNavDirections.discoveryToDetails(7),
                extras
            )
        }, 7)
        ...
        Log.e("animation", "create_view")
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        Log.e("animation", "viewCreated")
