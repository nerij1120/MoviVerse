...
import com.example.moviverse.databinding.FragmentRomanceBinding
import com.example.moviverse.viewmodel.DetailsViewModel
import com.example.moviverse.viewmodel.discovery.RomanceViewModel
import java.util.*
...
class RomanceFragment : Fragment() {
    ...
    private var _binding: FragmentRomanceBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRomanceBinding.inflate(inflater, container, false)
        ...
        adapter = MovieSearchAdapter(ArrayList(), onClick = {
            ...
            val extras = FragmentNavigatorExtras(
                poster to "movie_poster_${movie.id}_6",
                title to "movie_title_${movie.id}_6",
            )
            findNavController().navigate(
                BottomNavDirections.discoveryToDetails(6),
                extras
            )
        }, 6)
