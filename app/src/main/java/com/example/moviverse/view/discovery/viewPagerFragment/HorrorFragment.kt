...
import com.example.moviverse.databinding.FragmentHorrorBinding
import com.example.moviverse.viewmodel.DetailsViewModel
import com.example.moviverse.viewmodel.discovery.HorrorViewModel
import java.util.*
...
class HorrorFragment : Fragment() {
    private lateinit var viewModel: HorrorViewModel
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(this)[HorrorViewModel::class.java]
        ...
        adapter = MovieSearchAdapter(ArrayList(), onClick = {
            ...
            val extras = FragmentNavigatorExtras(
                poster to "movie_poster_${movie.id}_5",
                title to "movie_title_${movie.id}_5",
            )
            findNavController().navigate(
                BottomNavDirections.discoveryToDetails(5),
                extras
            )
        }, 5)
